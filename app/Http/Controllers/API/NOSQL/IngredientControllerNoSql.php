...
class IngredientControllerNoSql extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $ingredientsNoSql = IngredientNoSql::all();

        // On retourne les informations des utilisateurs en JSON
        return response()->json($ingredientsNoSql);
    }
     ...
     */
    public function show(IngredientNoSql $ingredientNoSql)
    {
        // On retourne les informations de l'utilisateur en JSON
        return response()->json($ingredientNoSql);
    }
    // /**
